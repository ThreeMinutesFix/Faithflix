...
public class HelperUtils {
    ...
    public static class CheckServerTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer statusCode) {
            if (statusCode == 200) {
                ...
                // Show appropriate toast message based on status code
                switch (statusCode) {
                    case -1:
                    ...
                    case -2:
                        ...
                        break;
                    case 403:
                        showToast("Access forbidden (403)");
                        break;
                    case 404:
                        showToast("Not found (404)");
                        break;
                    case 503:
                        showToast("Service unavailable (503)");
                        break;
                    default:
                        showToast("Unexpected response: " + statusCode);
                        break;
                }
            }
        }
    ...
    public static ArrayList<String> generateTimePoints() {
        ...
        try {
            ...
            while (!startTime.after(endTime)) {
                timePoints.add(sdf.format(startTime));
                startTime = new Date(startTime.getTime() + 30 * 60 * 1000); // Add 30 minutes
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
